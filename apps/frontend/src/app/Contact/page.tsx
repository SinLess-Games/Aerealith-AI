...
const contactOptions: ContactOptionCard[] = (
  Array.isArray(CONTACT_OPTIONS) ? CONTACT_OPTIONS : []
).map((option, index) => {
  const contactOption = option as LooseContactOption;

  return {
    title: text(contactOption.title, `Contact Option ${index + 1}`),
    description: text(
      contactOption.description,
      "Use this contact option to connect with Aerealith AI.",
    ),
    image: imagePath(contactOption.image),
    link: text(contactOption.link),
    buttonText: text(contactOption.buttonText),
  };
});
          ...
          >
            ...
            >
              <Image
                ...
                alt="Aerealith AI contact options"
                fill
                priority
            ...
            >
              Connect with Aerealith AI through the channels below for community
              updates, technical support, project feedback, feature requests,
              collaboration opportunities, and launch announcements. Whether you
              want to follow development progress, ask a question, report an
              issue, suggest an integration, support the project, or share ideas
              that could help shape the future of the platform, this is the best
              place to reach us. Aerealith AI is being built around real users,
              real workflows, and real-world problems, so your feedback helps
              guide what we improve, prioritize, and build next.
            </Typography>
          </Box>
