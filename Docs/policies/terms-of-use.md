...
- [User-Generated Content Policy](./user-generated-content.md), if published
- [Marketplace Policy](./marketplace.md), if published
- [Developer and API Policy](./developer-api.md), if published
- [Underage Policy](./underage.md), if published
...
Use by minors is governed by the applicable [Underage Policy](./underage.md), if published, and by applicable law.
...
Data handling is described in the [Data Policy](./data.md) and [Privacy Policy](./privacy.md).

## 18. No Sale of User Data
...
- Follow these Terms
- Follow the [Acceptable Use Policy](./acceptable-use.md)
...
- The [Responsible AI Policy](./responsible-ai.md)
- The [Copyright Takedown Policy](./copyright-takedown.md)
- The applicable marketplace policy, if published
- The applicable developer policy, if published
...
Marketplace billing is governed by the [Billing, Refund, and Cancellation Policy](./billing-refund-cancellation.md) and [Payment Processor Compliance Policy](./payment-proccessor-compliance.md).
...
Billing, refunds, cancellations, trials, renewals, taxes, failed payments, and chargebacks are governed by the [Billing, Refund, and Cancellation Policy](./billing-refund-cancellation.md).
...
Cancellation stops future renewals but does not automatically provide a refund for past charges unless required by law, stated in the [Billing, Refund, and Cancellation Policy](./billing-refund-cancellation.md), or approved by SinLess Games LLC.
...
Feature changes do not automatically entitle you to a refund unless required by law, stated in the [Billing, Refund, and Cancellation Policy](./billing-refund-cancellation.md), or agreed in writing.

## 42. Data Export and Deletion
...
Data export and deletion are governed by the [Data Policy](./data.md) and [Privacy Policy](./privacy.md).
...
You may request account deletion according to the [Privacy Policy](./privacy.md) and [Data Policy](./data.md).
...
Copyright complaints are governed by the [Copyright Takedown Policy](./copyright-takedown.md).

Copyright notices should be sent to:

`copyright@sinlessgames.com`
...
Before filing a legal claim, you agree to first contact SinLess Games LLC at:
...
unless a written agreement, arbitration provision, consumer protection law, or applicable mandatory law requires otherwise.

Before publishing, confirm the correct venue with qualified legal counsel.

## 63. Injunctive Relief
...
Formal legal notices to SinLess Games LLC should be sent to:
