...
## 9. Private Use Attribution Exception
...
## 10. Internal Business Use Attribution
...
## 13. Attribution When Space Is Limited
...
You may not create, upload, generate, publish, distribute, sell, or share User Content that violates the [Acceptable Use Policy](./acceptable-use.md).
...
## 22. Secrets and Credentials in User Content
...
## 27. Reviews, Comments, and Community Content
...
- Copyright: `copyright@sinlessgames.com`
...
## 34. Copyright Takedowns

Copyright complaints must follow the [Copyright Takedown Policy](./copyright-takedown.md).
...
## 35. Trademark and Brand Complaints

Trademark and brand complaints should be sent to:
...
## 37. Content Retention and Deletion

User Content may be retained or deleted according to the [Data Policy](./data.md), [Privacy Policy](./privacy.md), account settings, organization settings, deployment configuration, and applicable agreements.
...
## 42. Content License to SinLess Games LLC
...
## 44. Organization License and Control
...
## 45. Self-Hosted, Hybrid, and Air-Gapped Deployments
...
## 48. Content Warnings and Disclosures
...
## 50. No Obligation to Host Content
...
## 51. No Endorsement of User Content
