...
By using Aerealith AI, you agree to follow this policy, our [Terms of Use](./terms-of-use.md), [Privacy Policy](./privacy-policy.md), [Data Policy](./data-policy.md), [Security Policy](./security-policy.md), and any other policies that apply to your account, organization, subscription, or deployment.
...
Use by minors is also governed by our [Underage Policy](./underage-policy.md).

## 6. Account, Identity, and Access Abuse
...
Good-faith security research is only permitted when it is lawful, authorized, non-destructive, and consistent with our [Security Policy](./security-policy.md). Testing must be limited to systems you own or systems where you have explicit permission to test.

## 8. Platform Integrity and Resource Abuse
...
Additional AI-specific rules may be provided in our [AI Transparency Policy](./ai-transparency-policy.md) and [Responsible AI Policy](./responsible-ai-policy.md).

## 10. Automations, Tools, and Connected Integrations
...
## 11. Content and User-Generated Material
...
User-generated content is also governed by our [User-Generated Content Policy](./user-generated-content-policy.md) and [Copyright Takedown Policy](./copyright-takedown-policy.md).
...
Copyright complaints and takedown requests are handled under our [Copyright Takedown Policy](./copyright-takedown-policy.md).

## 13. Privacy and Personal Data Abuse
...
Personal data handling is governed by our [Privacy Policy](./privacy-policy.md) and [Data Policy](./data-policy.md).

## 14. Regulated and High-Risk Use
...
## 15. Marketplace, Plugins, and Developer Tools
...
## 17. Self-Hosted and Air-Gapped Deployments
...
- [AI Transparency Policy](./ai-transparency-policy.md)
- [Responsible AI Policy](./responsible-ai-policy.md)
- [User-Generated Content Policy](./user-generated-content-policy.md)
- [Copyright Takedown Policy](./copyright-takedown-policy.md)
