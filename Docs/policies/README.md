---
title: Policy Index
description: Index of Aerealith AI policies, policy statuses, publication readiness, and legal review warnings.
...
# Aerealith AI Policy Index

## Important Notice

This directory contains Aerealith AI policy documents for SinLess Games LLC.
...
- Consistency with actual Aerealith AI behavior
...
| `active`     | Published, effective, and intended to govern Aerealith AI usage.                                            |               Yes |
...
| ---------------------------------------- | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------- |
| Acceptable Use Policy                    | [acceptable-use.md](./acceptable-use.md)                               | Defines prohibited and restricted use of Aerealith AI, including abuse, fraud, malware, unsafe automation, harassment, privacy violations, and illegal activity.                            | Draft          |
| AI Transparency Policy                   | [ai-transparency.md](./ai-transparency.md)                             | Explains how Aerealith AI uses AI, memory, tools, model routing, generated output, human review, and user responsibility.                                                                   | Draft          |
...
| Incident Notification Policy             | [incident-notification.md](./incident-notification.md)                 | Explains how Aerealith AI classifies, communicates, escalates, and reports service, security, privacy, data, AI safety, automation, and vendor incidents.                                   | Draft          |
...
| Subprocessor and Vendor List             | [subprocessor-vendor-list.md](./subprocessor-vendor-list.md)           | Lists current, planned, optional, and customer-controlled vendors and subprocessors used or expected for Aerealith AI.                                                                      | Draft          |
...
| Terms of Use                             | [terms-of-use.md](./terms-of-use.md)                                   | Defines the core legal terms for using Aerealith AI, including accounts, AI output, user data, subscriptions, APIs, marketplace, liability, and termination.                                | Draft          |
...
| User-Generated Content Policy            | [user-generated-content.md](./user-generated-content.md)               | Explains user ownership of generated content, required Aerealith AI attribution, public sharing, moderation, copyright, marketplace content, and synthetic media rules.                     | Draft          |
...
| Law Enforcement Request Policy                   | `law-enforcement-requests.md`              | Explains how Aerealith AI handles subpoenas, warrants, emergency requests, preservation requests, and user notice.                  |
